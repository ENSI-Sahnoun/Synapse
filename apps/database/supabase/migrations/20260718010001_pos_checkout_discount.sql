-- Cashier-applied discount on the cart total (e.g. staff comp, loyalty
-- promo). Line items keep their full unit_price_dt for per-product margin
-- reporting; only purchases.total_dt reflects the discounted amount actually
-- collected.

ALTER TABLE public.purchases
  ADD COLUMN IF NOT EXISTS discount_dt numeric NOT NULL DEFAULT 0;
