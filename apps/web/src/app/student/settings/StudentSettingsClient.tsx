...
import { Bell, EnvelopeSimple, LockKey, At, CaretDown } from '@phosphor-icons/react'
import { Switch } from '@/components/ui/switch'
import { updateEmailAction, updatePasswordAction, updateNotificationPrefsAction } from '@/actions/student/account'
...
export function StudentSettingsClient({ initialPush, initialEmailDigest, currentEmail }: Props) {
